...
from utills.base import draw_train_history, mkdir
...
'''General Setting'''
train_name = \
    "ti" + str(time.strftime("%Y_%m_%d_%H_%M", time.localtime())) + \
...
with strategy.scope():
    ...
    history = model.fit(train_generator,
                        ...
                        validation_freq=5,
                        callbacks=[tf.keras.callbacks.TensorBoard(log_dir=train_log_path)]
                        )
